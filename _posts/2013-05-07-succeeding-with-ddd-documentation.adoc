...
Two excellent resources released since I wrote this article are:

* https://www.amazon.com/Living-Documentation-Cyrille-Martraire/dp/0134689321[Living Documentation: Continuous Knowledge Sharing by Design] by Cyrille Martraire
* https://leanpub.com/b/software-architecture[Software Architecture for Developers: Volumes 1 & 2 - Technical leadership and communication] by Simon Brown

== Updates

* [Updated 24 Oct 2019] - Added _Further Resources_ section
