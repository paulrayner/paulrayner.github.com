...
Have you experienced confusion from your wide range of stakeholders in deciphering your cloud migration strategy? Using the typical lengthy variations verbs starting with "R" (rehost - replatform - rearchitect - retire) or complicated frameworks may actually make your approach less clear. A simple visual model can go a long way in providing clarity in navigating the inevitable complexity of a cloud migration.
...
[quote, Gregor Hohpe]
____
Moving out into the cloud transforms how an enterprise operates and acquires IT infrastructure from an asset-based model to usage-based model.
____
